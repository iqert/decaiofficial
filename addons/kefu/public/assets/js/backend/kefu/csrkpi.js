            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'last_reception_time', title: __('Last_reception_time'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime, sortable:true},
                        {field: 'keep_alive', title: __('Keep Alive'), searchList: {"0": __('关'), "1": __('开')}, formatter: Table.api.formatter.status},
