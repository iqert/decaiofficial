    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'sender_identity', title: __('Sender_identity'), searchList: {"0":__('Sender_identity 0'),"1":__('Sender_identity 1')}, formatter: Table.api.formatter.normal, sortable:true},
                        {field: 'sender_id', title: __('Sender_id'), sortable:true},
                        {field: 'message_type', title: __('Message_type'), searchList: {"0":__('Message_type 0'),"1":__('Message_type 1'),"2":__('Message_type 2'),"3":__('Message_type 3')}, formatter: Table.api.formatter.normal, sortable:true},
                        {field: 'message', title: __('Message'), operate:'LIKE', placeholder:'模糊查找', formatter: Controller.api.formatter.message},
        ...
        api: {
            ...
            buildChatImg: function (filename, facename, class_name = 'emoji') {
                ...
                return '<a target="_blank" href="'+filename+'"><img class="' + class_name + '" title="' + facename + '" src="' + filename + '" /></a>';
            },
